...
<tr><td>[`float Gravity`](SpaceEngineers.Game.ModAPI.Ingame.Gravity)</td><td>Gets the gravity acceleration<br/><br/>_Inherited from <a href="SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGeneratorBase"><code>float Gravity</code></a>_</td></tr>
<tr><td>[`float GravityAcceleration`](SpaceEngineers.Game.ModAPI.Ingame.GravityAcceleration)</td><td>Gets or sets the gravity acceleration in m/s^2.<br/><br/>_Inherited from <a href="SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGeneratorBase"><code>float GravityAcceleration</code></a>_</td></tr>
</table>
### Methods
<table style="width:100%;display:table">
