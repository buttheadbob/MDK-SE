...
|Member|Description|
|---|---|
|[UpgradeCount { get; }](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.UpgradeCount)|Gets number of upgrades applied|
...
|Member|Description|
|---|---|
|[GetUpgrades(out Dictionary)](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.GetUpgrades)|Get list of upgrades. Read only.|
