...
```csharp
private public float Dot(private public sealed struct.Vector3 vector1, private public sealed struct.Vector3 vector2)
```
...
```csharp
private public void Dot(ref private public sealed struct.Vector3 vector1, ref private public sealed struct.Vector3 vector2, ref float result)
```
...
```csharp
private public float Dot(private public sealed struct.Vector3 v)
```
...
```csharp
private public float Dot(ref private public sealed struct.Vector3 v)
```
