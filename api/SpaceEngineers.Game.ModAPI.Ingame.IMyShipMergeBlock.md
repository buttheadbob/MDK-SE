...
```csharp
private public interface.IMyShipMergeBlock
```
...
|Member|Description|
|---|---|
|[IsConnected](SpaceEngineers.Game.ModAPI.Ingame.IMyShipMergeBlock.IsConnected)|Gets if the merge block is connected to another one.|
