...
```csharp
public public sealed struct Vector3D DominantAxisProjection(public sealed struct Vector3D value1)
```
...
```csharp
public void DominantAxisProjection(ref public sealed struct Vector3D value1, ref public sealed struct Vector3D result)
```
