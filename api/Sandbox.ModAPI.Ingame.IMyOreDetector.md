...
```csharp
private public interface.IMyOreDetector
```
...
|Member|Description|
|---|---|
|[Range](Sandbox.ModAPI.Ingame.IMyOreDetector.Range)||
|[BroadcastUsingAntennas](Sandbox.ModAPI.Ingame.IMyOreDetector.BroadcastUsingAntennas)||
