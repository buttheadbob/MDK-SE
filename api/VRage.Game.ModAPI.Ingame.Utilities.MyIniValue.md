...
[void GetLines(List&lt;string&gt;)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.GetLines)

> Retrieves each individual line of this value into the provided list.

[bool ToBoolean(bool = default)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToBoolean)
...
[byte ToByte(byte = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToByte)
...
[char ToChar(char = default)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToChar)
...
[decimal ToDecimal(decimal = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToDecimal)
...
[double ToDouble(double = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToDouble)
...
[short ToInt16(short = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToInt16)
...
[int ToInt32(int = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToInt32)
...
[long ToInt64(long = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToInt64)
...
[sbyte ToSByte(sbyte = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToSByte)
...
[float ToSingle(float = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToSingle)
...
[string ToString(string)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToString)
...
[ushort ToUInt16(ushort = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToUInt16)
...
[uint ToUInt32(uint = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToUInt32)
...
[ulong ToUInt64(ulong = 0)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.ToUInt64)
...
[bool TryGetBoolean(out bool)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetBoolean)
...
[bool TryGetByte(out byte)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetByte)
...
[bool TryGetChar(out char)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetChar)
...
[bool TryGetDecimal(out decimal)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetDecimal)
...
[bool TryGetDouble(out double)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetDouble)
...
[bool TryGetInt16(out short)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetInt16)
...
[bool TryGetInt32(out int)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetInt32)
...
[bool TryGetInt64(out long)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetInt64)
...
[bool TryGetSByte(out sbyte)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetSByte)
...
[bool TryGetSingle(out float)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetSingle)
...
[bool TryGetString(out string)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetString)
...
[bool TryGetUInt16(out ushort)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetUInt16)
...
[bool TryGetUInt32(out uint)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetUInt32)
...
[bool TryGetUInt64(out ulong)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.TryGetUInt64)
...
[void Write(StringBuilder)](VRage.Game.ModAPI.Ingame.Utilities.MyIniValue.Write)
