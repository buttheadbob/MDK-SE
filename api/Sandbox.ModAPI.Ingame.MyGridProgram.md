...
|Member|Description|
|---|---|
|[Action<System.String> Echo { get; protected set; }](Sandbox.ModAPI.Ingame.MyGridProgram.Echo)|Prints out text onto the currently running programmable block's detail info area.|
