...
|[uint UpgradeCount { get; }](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.UpgradeCount)|Gets number of upgrades applied|
...
|[void GetUpgrades(out Dictionary\<string, float>)](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.GetUpgrades)|Get list of upgrades. Read only.|
