...
|Member|Description|
|---|---|
|\\%1IMyMechanicalConnectionBlock Base { get; }](Sandbox.ModAPI.Ingame.IMyAttachableTopBlock.Base)|Gets the attached base block<br /><br />_Inherited from [IMyAttachableTopBlock](Sandbox.ModAPI.Ingame.IMyAttachableTopBlock)_|
...
|\\%1bool IsAttached { get; }](Sandbox.ModAPI.Ingame.IMyAttachableTopBlock.IsAttached)|Gets whether the top part is attached to a base block<br /><br />_Inherited from [IMyAttachableTopBlock](Sandbox.ModAPI.Ingame.IMyAttachableTopBlock)_|
