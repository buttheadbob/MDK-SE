...
|[static BoundingBox2D CreateFromPoints(IEnumerable<VRageMath.Vector2D>)](VRageMath.BoundingBox2D.CreateFromPoints)|Creates the smallest BoundingBox2D that will contain a group of points.|
