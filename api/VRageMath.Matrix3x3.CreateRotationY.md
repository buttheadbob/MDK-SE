...
```csharp
public public sealed struct Matrix3x3 CreateRotationY(float radians)
```
...
```csharp
public void CreateRotationY(float radians, ref public sealed struct Matrix3x3 result)
```
