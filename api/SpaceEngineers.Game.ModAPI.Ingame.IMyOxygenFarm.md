...
|\$1bool CanProduce { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyOxygenFarm.CanProduce)|Gets if the block can produce gas.|
...
|\$1float GetOutput()](SpaceEngineers.Game.ModAPI.Ingame.IMyOxygenFarm.GetOutput)||
