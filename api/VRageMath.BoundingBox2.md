...
|[`CornerCount`](VRageMath.CornerCount)|Specifies the total number of corners (8) in the BoundingBox2.|
### Properties
|Member|Description|
|---|---|
...
|[`CreateMerged(BoundingBox2, BoundingBox2)`](VRageMath.CreateMerged)|Creates the smallest BoundingBox2 that contains the two specified BoundingBox2 instances.|
|[`CreateMerged(ref BoundingBox2, ref BoundingBox2, ref BoundingBox2)`](VRageMath.CreateMerged)|Creates the smallest BoundingBox2 that contains the two specified BoundingBox2 instances.|
|[`CreateFromPoints(IEnumerable<Vector2>)`](VRageMath.CreateFromPoints)|Creates the smallest BoundingBox2 that will contain a group of points.|
|[`CreateFromHalfExtent(Vector2, float)`](VRageMath.CreateFromHalfExtent)||
|[`CreateFromHalfExtent(Vector2, Vector2)`](VRageMath.CreateFromHalfExtent)||
