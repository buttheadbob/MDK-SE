...
```csharp[Vector3D](VRageMath.Vector3D) DominantAxisProjection([Vector3D](VRageMath.Vector3D) value1)```##### Summary
...
```csharpvoid DominantAxisProjection(ref [Vector3D](VRageMath.Vector3D) value1, ref [Vector3D](VRageMath.Vector3D) result)```##### Summary
