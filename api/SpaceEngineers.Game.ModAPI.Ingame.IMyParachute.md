...
|Member|Description|
|---|---|
|[`float Atmosphere`](SpaceEngineers.Game.ModAPI.Ingame.Atmosphere)||
|[`DoorStatus Status`](SpaceEngineers.Game.ModAPI.Ingame.Status)||
|[`float OpenRatio`](SpaceEngineers.Game.ModAPI.Ingame.OpenRatio)||
...
|[`bool HasInventory`](VRage.Game.ModAPI.Ingame.HasInventory)|_Inherited from [`IMyEntity`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`int InventoryCount`](VRage.Game.ModAPI.Ingame.InventoryCount)|_Inherited from [`IMyEntity`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
...
|[`IMyCubeGrid CubeGrid`](VRage.Game.ModAPI.Ingame.CubeGrid)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`string DefinitionDisplayNameText`](VRage.Game.ModAPI.Ingame.DefinitionDisplayNameText)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`float DisassembleRatio`](VRage.Game.ModAPI.Ingame.DisassembleRatio)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`string DisplayNameText`](VRage.Game.ModAPI.Ingame.DisplayNameText)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`bool IsBeingHacked`](VRage.Game.ModAPI.Ingame.IsBeingHacked)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`bool IsFunctional`](VRage.Game.ModAPI.Ingame.IsFunctional)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`bool IsWorking`](VRage.Game.ModAPI.Ingame.IsWorking)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`Vector3I Max`](VRage.Game.ModAPI.Ingame.Max)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`float Mass`](VRage.Game.ModAPI.Ingame.Mass)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`Vector3I Min`](VRage.Game.ModAPI.Ingame.Min)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`int NumberInGrid`](VRage.Game.ModAPI.Ingame.NumberInGrid)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`MyBlockOrientation Orientation`](VRage.Game.ModAPI.Ingame.Orientation)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`long OwnerId`](VRage.Game.ModAPI.Ingame.OwnerId)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
|[`Vector3I Position`](VRage.Game.ModAPI.Ingame.Position)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
...
|[`string CustomData`](Sandbox.ModAPI.Ingame.CustomData)|_Inherited from [`IMyTerminalBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
...
|Member|Description|
|---|---|
|[`bool TryGetClosestPoint(ref Nullable<Vector3D> closestPoint)`](SpaceEngineers.Game.ModAPI.Ingame.TryGetClosestPoint)||
|[`Vector3D GetVelocity()`](SpaceEngineers.Game.ModAPI.Ingame.GetVelocity)||
|[`Vector3D GetNaturalGravity()`](SpaceEngineers.Game.ModAPI.Ingame.GetNaturalGravity)||
|[`Vector3D GetArtificialGravity()`](SpaceEngineers.Game.ModAPI.Ingame.GetArtificialGravity)||
|[`Vector3D GetTotalGravity()`](SpaceEngineers.Game.ModAPI.Ingame.GetTotalGravity)||
|[`void OpenDoor()`](SpaceEngineers.Game.ModAPI.Ingame.OpenDoor)||
|[`void CloseDoor()`](SpaceEngineers.Game.ModAPI.Ingame.CloseDoor)||
|[`void ToggleDoor()`](SpaceEngineers.Game.ModAPI.Ingame.ToggleDoor)||
|[`IMyInventory GetInventory()`](VRage.Game.ModAPI.Ingame.GetInventory)|_Inherited from [`IMyEntity`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
...
|[`string GetOwnerFactionTag()`](VRage.Game.ModAPI.Ingame.GetOwnerFactionTag)|_Inherited from [`IMyCubeBlock`](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute)_|
