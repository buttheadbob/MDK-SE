...
|Member|Description|
|---|---|
|[Open { get; }](Sandbox.ModAPI.Ingame.IMyDoor.Open)|_**Obsolete:** Use the Status property instead_|
|[Status { get; }](Sandbox.ModAPI.Ingame.IMyDoor.Status)||
|[OpenRatio { get; }](Sandbox.ModAPI.Ingame.IMyDoor.OpenRatio)||
...
|Member|Description|
|---|---|
|[OpenDoor()](Sandbox.ModAPI.Ingame.IMyDoor.OpenDoor)||
|[CloseDoor()](Sandbox.ModAPI.Ingame.IMyDoor.CloseDoor)||
|[ToggleDoor()](Sandbox.ModAPI.Ingame.IMyDoor.ToggleDoor)||
