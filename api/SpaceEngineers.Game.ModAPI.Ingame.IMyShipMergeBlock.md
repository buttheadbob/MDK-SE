...
* MyObjectBuilder_MergeBlock/SmallShipSmallMergeBlock
...
|[bool IsConnected { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyShipMergeBlock.IsConnected)|Gets if the merge block is locked to another one.|
...
|[MergeState State { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyShipMergeBlock.State)|State of the merge block|
