...
|Member|Description|
|---|---|
|[Atmosphere { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Atmosphere)|Atmospheric Density at the block. Returns 0.0f if not near a planet.|
|[Status { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Status)|Determines the current general status of the door.|
|[OpenRatio { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.OpenRatio)|The current, accurate ratio of the door's current state where 0 is fully closed and 1 is fully open.|
|[AutoDeploy { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.AutoDeploy)|Gets or sets if the parachute should automatically deploy.|
|[AutoDeployHeight { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.AutoDeployHeight)|Gets or sets the altitude (in meters) that the parachute should auto deploy.|
...
|Member|Description|
|---|---|
|[TryGetClosestPoint(out Vector3D?)](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.TryGetClosestPoint)||
...
|[GetTotalGravity()](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.GetTotalGravity)|Gets the total accumulated gravity vector and power at the current location, taking both natural and artificial gravity into account.|
|[OpenDoor()](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.OpenDoor)|Opens the door. See [Status](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Status) to get the current status.|
|[CloseDoor()](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.CloseDoor)|Closes the door. See [Status](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Status) to get the current status.|
|[ToggleDoor()](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.ToggleDoor)|Toggles the open state of this door. See [Status](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Status) to get the current status.|
