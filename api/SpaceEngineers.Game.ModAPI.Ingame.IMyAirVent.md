...
```csharp
private public abstract IMyAirVent
```csharp
...
|Member|Description|
|---|---|
|[CanPressurize](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.CanPressurize)|Can fill room with air true - room is airtight false - room is not airtight|
|[IsDepressurizing](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.IsDepressurizing)|_**Obsolete:** IsDepressurizing is deprecated, please use Depressurize instead._<br /><br />Vent mode false - pressurize (filling room) true - depressurize (sucking air out)|
|[Depressurize](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Depressurize)|Vent mode false - pressurize (filling room) true - depressurize (sucking air out)|
|[Status](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Status)|Gets current air vent status|
|[PressurizationEnabled](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.PressurizationEnabled)|Returns true if pressurization is enabled.|
...
|Member|Description|
|---|---|
|[IsPressurized()](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.IsPressurized)|_**Obsolete:** IsPressurized() is deprecated, please use CanPressurize instead._<br /><br />Room can be pressurized|
|[GetOxygenLevel()](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.GetOxygenLevel)|Oxygen level in room|
