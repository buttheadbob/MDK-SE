...
|Member|Description|
|---|---|
|[Angle](Sandbox.ModAPI.Ingame.IMyMotorStator.Angle)|Gets the current angle of the rotor in radians.|
|[Torque](Sandbox.ModAPI.Ingame.IMyMotorStator.Torque)|Gets or sets the torque applied when moving the rotor top|
|[BrakingTorque](Sandbox.ModAPI.Ingame.IMyMotorStator.BrakingTorque)|Gets or sets the torque applied when stopping the rotor top|
|[TargetVelocityRad](Sandbox.ModAPI.Ingame.IMyMotorStator.TargetVelocityRad)|Gets or sets the desired velocity of the rotor in radians/second|
|[TargetVelocityRPM](Sandbox.ModAPI.Ingame.IMyMotorStator.TargetVelocityRPM)|Gets or sets the desired velocity of the rotor in RPM|
|[LowerLimitRad](Sandbox.ModAPI.Ingame.IMyMotorStator.LowerLimitRad)|Gets or sets the lower angle limit of the rotor in radians. Set to float.MinValue for no limit.|
|[LowerLimitDeg](Sandbox.ModAPI.Ingame.IMyMotorStator.LowerLimitDeg)|Gets or sets the lower angle limit of the rotor in degrees. Set to float.MinValue for no limit.|
|[UpperLimitRad](Sandbox.ModAPI.Ingame.IMyMotorStator.UpperLimitRad)|Gets or sets the upper angle limit of the rotor in radians. Set to float.MaxValue for no limit.|
|[UpperLimitDeg](Sandbox.ModAPI.Ingame.IMyMotorStator.UpperLimitDeg)|Gets or sets the upper angle limit of the rotor in degrees. Set to float.MaxValue for no limit.|
|[Displacement](Sandbox.ModAPI.Ingame.IMyMotorStator.Displacement)|Gets or sets the vertical displacement of the rotor top|
|[RotorLock](Sandbox.ModAPI.Ingame.IMyMotorStator.RotorLock)|Gets or sets rotor lock|
