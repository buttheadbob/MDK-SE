...
|Member|Description|
|---|---|
|[CanProduce { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyOxygenFarm.CanProduce)|Gets if the block can produce gas.|
...
|Member|Description|
|---|---|
|[GetOutput()](SpaceEngineers.Game.ModAPI.Ingame.IMyOxygenFarm.GetOutput)||
