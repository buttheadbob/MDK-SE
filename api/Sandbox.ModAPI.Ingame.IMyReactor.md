...
* MyObjectBuilder_Reactor/SmallBlockLargeGeneratorWarfare2  
* MyObjectBuilder_Reactor/SmallBlockSmallGenerator  
* MyObjectBuilder_Reactor/SmallBlockSmallGeneratorWarfare2
...
|[bool UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyReactor.UseConveyorSystem)|Gets or sets whether this reactor block should pull items from conveyor system|
