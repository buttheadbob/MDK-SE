...
```csharp
private public double Dot(private public sealed struct.Vector2D value1, private public sealed struct.Vector2D value2)
```
...
```csharp
private public void Dot(ref private public sealed struct.Vector2D value1, ref private public sealed struct.Vector2D value2, ref double result)
```
