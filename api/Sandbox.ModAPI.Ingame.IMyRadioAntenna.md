...
```csharp
private public abstract IMyRadioAntenna
```csharp
...
|Member|Description|
|---|---|
|[Radius](Sandbox.ModAPI.Ingame.IMyRadioAntenna.Radius)|Broadcasting/Receiving range|
|[ShowShipName](Sandbox.ModAPI.Ingame.IMyRadioAntenna.ShowShipName)|Show shipname on hud|
|[IsBroadcasting](Sandbox.ModAPI.Ingame.IMyRadioAntenna.IsBroadcasting)|Returns true if antena is broadcasting|
