...
|Member|Description|
|---|---|
|[void GetActions(List, [Func])](Sandbox.ModAPI.Ingame.IMyTerminalBlock.GetActions)|Get all terminal actions available for block|
...
|[void GetProperties(List, [Func])](Sandbox.ModAPI.Ingame.IMyTerminalBlock.GetProperties)|Get all terminal actions available for block.|
...
|[void SearchActionsOfName(string, List, [Func])](Sandbox.ModAPI.Ingame.IMyTerminalBlock.SearchActionsOfName)|Get all terminal actions available for block. NOTE: First called `<br /><br />` and then `<br /><br />` check|
