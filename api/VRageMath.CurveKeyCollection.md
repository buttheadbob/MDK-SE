...
|[`int Count`](VRageMath.Count)||
|[`bool IsReadOnly`](VRageMath.IsReadOnly)||
### Methods
|Member|Description|
|---|---|
...
|[`void CopyTo(CurveKey[] array, int arrayIndex)`](VRageMath.CopyTo)||
...
|[`IEnumerator<CurveKey> GetEnumerator()`](VRageMath.GetEnumerator)||
|[`CurveKeyCollection Clone()`](VRageMath.Clone)||
