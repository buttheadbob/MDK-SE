...
<tr><td>_<a href="Sandbox.ModAPI.Ingame.CanControl"><code>bool CanControl</code></a>_</td><td></td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Range"><code>float Range</code></a>_</td><td></td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.IsAimed"><code>bool IsAimed</code></a>_</td><td></td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.HasTarget"><code>bool HasTarget</code></a>_</td><td>Checks if the turret is locked onto a target</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Elevation"><code>float Elevation</code></a>_</td><td>Sets/gets elevation of turret, this method is not synced, you need to sync elevation manually</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Azimuth"><code>float Azimuth</code></a>_</td><td>Sets/gets azimuth of turret, this method is not synced, you need to sync azimuth manually</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.EnableIdleRotation"><code>bool EnableIdleRotation</code></a>_</td><td>enable/disable idle rotation for turret, this method is not synced, you need to sync manually</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.AIEnabled"><code>bool AIEnabled</code></a>_</td><td>Checks is AI is enabled for turret</td></tr>
...
<tr><td>_<a href="Sandbox.ModAPI.Ingame.IsShooting"><code>bool IsShooting</code></a>_</td><td>_Inherited from <a href="Sandbox.ModAPI.Ingame.IMyUserControllableGun"><code>IMyUserControllableGun</code></a>_</td></tr>
</table>
### Methods
<table style="width:100%;display:table">
<tr><td>_<a href="Sandbox.ModAPI.Ingame.TrackTarget"><code>void TrackTarget(Vector3D pos, Vector3 velocity)</code></a>_</td><td>Tracks given target with enabled position prediction</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.SetTarget"><code>void SetTarget(Vector3D pos)</code></a>_</td><td>Targets given position</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.SyncElevation"><code>void SyncElevation()</code></a>_</td><td>method used to sync elevation of turret , you need to call it to sync elevation for other clients/server</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.SyncAzimuth"><code>void SyncAzimuth()</code></a>_</td><td>method used to sync azimuth, you need to call it to sync azimuth for other clients/server</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.SyncEnableIdleRotation"><code>void SyncEnableIdleRotation()</code></a>_</td><td>method used to sync idle rotation and elevation, you need to call it to sync rotation and elevation for other clients/server</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.ResetTargetingToDefault"><code>void ResetTargetingToDefault()</code></a>_</td><td>resert targeting to default values</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.GetTargetedEntity"><code>MyDetectedEntityInfo GetTargetedEntity()</code></a>_</td><td>Gets the turret's current detected entity, if any</td></tr>
