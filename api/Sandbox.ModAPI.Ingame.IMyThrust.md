...
|\\%1float CurrentThrust { get; }](Sandbox.ModAPI.Ingame.IMyThrust.CurrentThrust)|Gets the current thrust amount, in Newtons (N)|
...
|\\%1Vector3I GridThrustDirection { get; }](Sandbox.ModAPI.Ingame.IMyThrust.GridThrustDirection)|Gets the direction of thrust, relative to ship controller (cockpit).|
...
|\\%1float MaxEffectiveThrust { get; }](Sandbox.ModAPI.Ingame.IMyThrust.MaxEffectiveThrust)|Gets the maximum effective thrust amount, in Newtons (N)|
|\\%1float MaxThrust { get; }](Sandbox.ModAPI.Ingame.IMyThrust.MaxThrust)|Gets the maximum thrust amount, in Newtons (N)|
...
|\\%1float ThrustOverride { get; set; }](Sandbox.ModAPI.Ingame.IMyThrust.ThrustOverride)|Gets or sets the override thrust amount, in Newtons (N)|
|\\%1float ThrustOverridePercentage { get; set; }](Sandbox.ModAPI.Ingame.IMyThrust.ThrustOverridePercentage)|Gets or sets the thrust override as a percentage between 0 and 1|
