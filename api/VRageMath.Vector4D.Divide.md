...
```csharp
public static void Divide(ref Vector4D value1, ref Vector4D value2, ref Vector4D result)
```
...
```csharp
public static void Divide(ref Vector4D value1, double divider, ref Vector4D result)
```
