...
|[void AddTools(List<Sandbox.ModAPI.Ingame.IMyFunctionalBlock>)](SpaceEngineers.Game.ModAPI.Ingame.IMyTurretControlBlock.AddTools)|Adds tools for the block|
...
|[List<System.String> GetTargetingGroups()](SpaceEngineers.Game.ModAPI.Ingame.IMyTurretControlBlock.GetTargetingGroups)|Gets all available targeting groups|
|[void GetTools(List<Sandbox.ModAPI.Ingame.IMyFunctionalBlock>)](SpaceEngineers.Game.ModAPI.Ingame.IMyTurretControlBlock.GetTools)|Gets tools for the block|
...
|[void RemoveTools(List<Sandbox.ModAPI.Ingame.IMyFunctionalBlock>)](SpaceEngineers.Game.ModAPI.Ingame.IMyTurretControlBlock.RemoveTools)|Removes tools for the block|
