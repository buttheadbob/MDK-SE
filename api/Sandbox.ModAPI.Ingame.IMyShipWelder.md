...
|Member|Description|
|---|---|
|[HelpOthers { get; set; }](Sandbox.ModAPI.Ingame.IMyShipWelder.HelpOthers)|True if welder is set to helper mode|
...
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyShipToolBase.UseConveyorSystem)|_Inherited from [IMyShipToolBase](Sandbox.ModAPI.Ingame.IMyShipToolBase)_|
