...
|[IsProducing { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.IsProducing)|Gets whether block is currently producing.<br /><br />_Inherited from [IMyProductionBlock](Sandbox.ModAPI.Ingame.IMyProductionBlock)_|
|[IsQueueEmpty { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.IsQueueEmpty)|Gets whether production queue is empty.<br /><br />_Inherited from [IMyProductionBlock](Sandbox.ModAPI.Ingame.IMyProductionBlock)_|
