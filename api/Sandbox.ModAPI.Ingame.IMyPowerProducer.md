...
|Member|Description|
|---|---|
|[CurrentOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer.CurrentOutput)|Current output in Megawatts|
|[MaxOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer.MaxOutput)|Maximum output in Megawatts|
