...
|Member|Description|
|---|---|
|[GyroPower { get; set; }](Sandbox.ModAPI.Ingame.IMyGyro.GyroPower)|Get or set gyroscope power in|
|[GyroOverride { get; set; }](Sandbox.ModAPI.Ingame.IMyGyro.GyroOverride)||
|[Yaw { get; set; }](Sandbox.ModAPI.Ingame.IMyGyro.Yaw)||
|[Pitch { get; set; }](Sandbox.ModAPI.Ingame.IMyGyro.Pitch)||
|[Roll { get; set; }](Sandbox.ModAPI.Ingame.IMyGyro.Roll)||
