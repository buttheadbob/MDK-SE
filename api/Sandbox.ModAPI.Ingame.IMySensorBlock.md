...
<tr><td>_<a href="Sandbox.ModAPI.Ingame.MaxRange"><code>float MaxRange</code></a>_</td><td>Gets the maximum range of the sensor in any direction.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.LeftExtend"><code>float LeftExtend</code></a>_</td><td>Gets or sets the left range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.RightExtend"><code>float RightExtend</code></a>_</td><td>Gets or sets the right range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.TopExtend"><code>float TopExtend</code></a>_</td><td>Gets or sets the top range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.BottomExtend"><code>float BottomExtend</code></a>_</td><td>Gets or sets the bottom range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.FrontExtend"><code>float FrontExtend</code></a>_</td><td>Gets or sets the front range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.BackExtend"><code>float BackExtend</code></a>_</td><td>Gets or sets the back range of the sensor.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.PlayProximitySound"><code>bool PlayProximitySound</code></a>_</td><td>Gets or sets if the proximity sound plays when an entity is detected.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectPlayers"><code>bool DetectPlayers</code></a>_</td><td>Gets or sets if the sensor should detect players.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectFloatingObjects"><code>bool DetectFloatingObjects</code></a>_</td><td>Gets or sets if the sensor should detect floating objects (components, rocks).</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectSmallShips"><code>bool DetectSmallShips</code></a>_</td><td>Gets or sets if the sensor should detect small ships.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectLargeShips"><code>bool DetectLargeShips</code></a>_</td><td>Gets or sets if the sensor should detect large ships.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectStations"><code>bool DetectStations</code></a>_</td><td>Gets or sets if the sensor should detect large stations.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectSubgrids"><code>bool DetectSubgrids</code></a>_</td><td>Gets or sets if the sensor should detect subgrids (eg. connected by connector).</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectAsteroids"><code>bool DetectAsteroids</code></a>_</td><td>Gets or sets if the sensor should detect asteroids or planets.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectOwner"><code>bool DetectOwner</code></a>_</td><td>Gets or sets if the sensor should detect the block owner.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectFriendly"><code>bool DetectFriendly</code></a>_</td><td>Gets or sets if the sensor should detect friendly players.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectNeutral"><code>bool DetectNeutral</code></a>_</td><td>Gets or sets if the sensor should detect neutral players.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectEnemy"><code>bool DetectEnemy</code></a>_</td><td>Gets or sets if the sensor should detect enemy players.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.IsActive"><code>bool IsActive</code></a>_</td><td>Gets if there is any entity currently being detected.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.LastDetectedEntity"><code>MyDetectedEntityInfo LastDetectedEntity</code></a>_</td><td></td></tr>
...
### Methods
<table style="width:100%;display:table">
<tr><td>_<a href="Sandbox.ModAPI.Ingame.DetectedEntities"><code>void DetectedEntities(List<MyDetectedEntityInfo> entities)</code></a>_</td><td></td></tr>
