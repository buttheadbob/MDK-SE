...
|Member|Description|
|---|---|
|[CanPressurize { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.CanPressurize)|Gets whether this vent can pressurize. If so room is airtight.|
|[IsDepressurizing { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.IsDepressurizing)|_**Obsolete:** IsDepressurizing is deprecated, please use Depressurize instead._<br /><br />Gets whether this vet is depressurizing|
|[Depressurize { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Depressurize)|Gets whether this vent is in depressurize state|
|[Status { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Status)|Gets the current air vent status|
|[PressurizationEnabled { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.PressurizationEnabled)|Gets whether this vent has pressurization enabled.|
...
|Member|Description|
|---|---|
|[IsPressurized()](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.IsPressurized)|_**Obsolete:** IsPressurized() is deprecated, please use CanPressurize instead._<br /><br />Gets whether this vent can be pressurized|
|[GetOxygenLevel()](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.GetOxygenLevel)|Gets Oxygen level in room|
