...
```csharp
public Vector4 SmoothStep(Vector4 value1, Vector4 value2, float amount)
```
...
```csharp
public void SmoothStep(ref Vector4 value1, ref Vector4 value2, float amount, ref Vector4 result)
```
