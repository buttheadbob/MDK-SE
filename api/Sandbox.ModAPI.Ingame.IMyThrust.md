...
|Member|Description|
|---|---|
|[ThrustOverride](Sandbox.ModAPI.Ingame.IMyThrust.ThrustOverride)|Gets or sets the override thrust amount, in Newtons (N)|
|[ThrustOverridePercentage](Sandbox.ModAPI.Ingame.IMyThrust.ThrustOverridePercentage)|Gets or sets the thrust override as a percentage between 0 and 1|
|[MaxThrust](Sandbox.ModAPI.Ingame.IMyThrust.MaxThrust)|Gets the maximum thrust amount, in Newtons (N)|
|[MaxEffectiveThrust](Sandbox.ModAPI.Ingame.IMyThrust.MaxEffectiveThrust)|Gets the maximum effective thrust amount, in Newtons (N)|
|[CurrentThrust](Sandbox.ModAPI.Ingame.IMyThrust.CurrentThrust)|Gets the current thrust amount, in Newtons (N)|
|[GridThrustDirection](Sandbox.ModAPI.Ingame.IMyThrust.GridThrustDirection)|Gets the direction of thrust, relative to ship controller (cockpit).|
