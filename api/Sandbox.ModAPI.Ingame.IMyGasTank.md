...
```csharp
private public interface.IMyGasTank
```
...
|Member|Description|
|---|---|
|[Stockpile](Sandbox.ModAPI.Ingame.IMyGasTank.Stockpile)|Gets or sets the stockpiling option for this gas tank. When stockpile is on, the tank will only allow itself to be filled, it will not release any gas.|
|[AutoRefillBottles](Sandbox.ModAPI.Ingame.IMyGasTank.AutoRefillBottles)|Gets or sets whether storage bottles will be filled automatically when placed within this tank.|
|[Capacity](Sandbox.ModAPI.Ingame.IMyGasTank.Capacity)|Gets the gas capacity of this tank.|
|[FilledRatio](Sandbox.ModAPI.Ingame.IMyGasTank.FilledRatio)|Gets the current fill level of this tank as a value between 0 (empty) and 1 (full).|
...
|Member|Description|
|---|---|
|[RefillBottles()](Sandbox.ModAPI.Ingame.IMyGasTank.RefillBottles)|Refills any stored storage bottles.|
