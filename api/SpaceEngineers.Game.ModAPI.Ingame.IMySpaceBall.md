...
|Member|Description|
|---|---|
|[Friction { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMySpaceBall.Friction)|Ball friction|
|[Restitution { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMySpaceBall.Restitution)|Ball restitution|
|[IsBroadcasting { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMySpaceBall.IsBroadcasting)|_**Obsolete:** Use IMySpaceBall.Broadcasting_<br /><br />Is broadcasting|
|[Broadcasting { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMySpaceBall.Broadcasting)|Gets or sets broadcasting|
|[VirtualMass { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMySpaceBall.VirtualMass)|Virtual mass of ball, in kg|
...
|[VirtualMass { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyVirtualMass.VirtualMass)|Virtualmass weight<br /><br />_Inherited from [IMyVirtualMass](SpaceEngineers.Game.ModAPI.Ingame.IMyVirtualMass)_|
