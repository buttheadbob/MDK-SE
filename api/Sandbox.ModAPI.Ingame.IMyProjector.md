...
|Member|Description|
|---|---|
|[ProjectionOffsetX](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionOffsetX)|_**Obsolete:** Use ProjectionOffset vector instead._|
|[ProjectionOffsetY](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionOffsetY)|_**Obsolete:** Use ProjectionOffset vector instead._|
|[ProjectionOffsetZ](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionOffsetZ)|_**Obsolete:** Use ProjectionOffset vector instead._|
|[ProjectionRotX](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionRotX)|_**Obsolete:** Use ProjectionRotation vector instead._|
|[ProjectionRotY](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionRotY)|_**Obsolete:** Use ProjectionRotation vector instead._|
|[ProjectionRotZ](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionRotZ)|_**Obsolete:** Use ProjectionRotation vector instead._|
|[IsProjecting](Sandbox.ModAPI.Ingame.IMyProjector.IsProjecting)|Checks if there is an active projection|
|[TotalBlocks](Sandbox.ModAPI.Ingame.IMyProjector.TotalBlocks)|Total number of blocks in the projection|
|[RemainingBlocks](Sandbox.ModAPI.Ingame.IMyProjector.RemainingBlocks)|Number of blocks left to be welded|
|[RemainingBlocksPerType](Sandbox.ModAPI.Ingame.IMyProjector.RemainingBlocksPerType)|A comprehensive list of blocks left to be welded|
|[RemainingArmorBlocks](Sandbox.ModAPI.Ingame.IMyProjector.RemainingArmorBlocks)|Number of armor blocks left to be welded|
|[BuildableBlocksCount](Sandbox.ModAPI.Ingame.IMyProjector.BuildableBlocksCount)|Count of blocks which can be welded now|
|[ProjectionOffset](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionOffset)||
|[ProjectionRotation](Sandbox.ModAPI.Ingame.IMyProjector.ProjectionRotation)|These values are not in degrees. 1 = 90 degrees, 2 = 180 degrees|
|[ShowOnlyBuildable](Sandbox.ModAPI.Ingame.IMyProjector.ShowOnlyBuildable)||
