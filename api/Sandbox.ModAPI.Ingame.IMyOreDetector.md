...
|[bool BroadcastUsingAntennas { get; set; }](Sandbox.ModAPI.Ingame.IMyOreDetector.BroadcastUsingAntennas)|Gets or sets whether block should use antennas to broadcast ore deposits|
...
|[float Range { get; }](Sandbox.ModAPI.Ingame.IMyOreDetector.Range)|Gets ore detection range in meters|
