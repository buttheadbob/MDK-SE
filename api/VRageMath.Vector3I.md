...
|[Min(ref Vector3I, ref Vector3I, out Vector3I)](VRageMath.Vector3I.Min)||
...
|[Max(ref Vector3I, ref Vector3I, out Vector3I)](VRageMath.Vector3I.Max)||
...
|[DominantAxisProjection(ref Vector3I, out Vector3I)](VRageMath.Vector3I.DominantAxisProjection)|Calculates a vector that is equal to the projection of the input vector to the coordinate axis that corresponds to the original vector's largest value. The result is saved into a user-specified variable.|
...
|[Round(ref Vector3, out Vector3I)](VRageMath.Vector3I.Round)||
|[Round(ref Vector3D, out Vector3I)](VRageMath.Vector3I.Round)||
...
|[Transform(ref Vector3I, ref Quaternion, out Vector3I)](VRageMath.Vector3I.Transform)||
|[Transform(Vector3I, Quaternion)](VRageMath.Vector3I.Transform)||
|[Transform(ref Vector3I, ref MatrixI, out Vector3I)](VRageMath.Vector3I.Transform)||
...
|[TransformNormal(ref Vector3I, ref Matrix, out Vector3I)](VRageMath.Vector3I.TransformNormal)|Transforms a vector normal by a matrix.|
|[TransformNormal(ref Vector3I, ref MatrixI, out Vector3I)](VRageMath.Vector3I.TransformNormal)||
|[Cross(ref Vector3I, ref Vector3I, out Vector3I)](VRageMath.Vector3I.Cross)|Calculates the cross product of two vectors.|
|[CompareTo(Vector3I)](VRageMath.Vector3I.CompareTo)||
|[Abs(Vector3I)](VRageMath.Vector3I.Abs)||
|[Abs(ref Vector3I, out Vector3I)](VRageMath.Vector3I.Abs)||
|[Clamp(Vector3I, Vector3I, Vector3I)](VRageMath.Vector3I.Clamp)||
|[Clamp(ref Vector3I, ref Vector3I, ref Vector3I, out Vector3I)](VRageMath.Vector3I.Clamp)||
...
|[Dot(ref Vector3I, ref Vector3I, out int)](VRageMath.Vector3I.Dot)||
|[TryParseFromString(string, out Vector3I)](VRageMath.Vector3I.TryParseFromString)||
