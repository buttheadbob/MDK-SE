...
|\\%1IMyInventory InputInventory { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.InputInventory)|Gets the input inventory.|
...
|\\%1bool IsProducing { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.IsProducing)|Gets whether block is currently producing.|
|\\%1bool IsQueueEmpty { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.IsQueueEmpty)|Gets whether production queue is empty.|
...
|\\%1uint NextItemId { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.NextItemId)|Gets the queue item ID of the next item to be produced.|
...
|\\%1IMyInventory OutputInventory { get; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.OutputInventory)|Gets the output inventory.|
...
|\\%1bool UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyProductionBlock.UseConveyorSystem)|Gets or sets whether this device should use the conveyor system to retrieve and store items.|
...
|Member|Description|
|---|---|
|\\%1void AddQueueItem(MyDefinitionId, MyFixedPoint)](Sandbox.ModAPI.Ingame.IMyProductionBlock.AddQueueItem)|Adds a blueprint to the production queue|
|\\%1void AddQueueItem(MyDefinitionId, decimal)](Sandbox.ModAPI.Ingame.IMyProductionBlock.AddQueueItem)|Adds a blueprint to the production queue|
|\\%1void AddQueueItem(MyDefinitionId, double)](Sandbox.ModAPI.Ingame.IMyProductionBlock.AddQueueItem)|Adds a blueprint to the production queue|
|\\%1bool CanUseBlueprint(MyDefinitionId)](Sandbox.ModAPI.Ingame.IMyProductionBlock.CanUseBlueprint)|Can this production block produce this blueprint?|
|\\%1void ClearQueue()](Sandbox.ModAPI.Ingame.IMyProductionBlock.ClearQueue)|Clears the Queue|
...
|\\%1void GetQueue(List\\%1MyProductionItem>)](Sandbox.ModAPI.Ingame.IMyProductionBlock.GetQueue)|Gets the current production queue|
...
|\\%1void InsertQueueItem(int, MyDefinitionId, MyFixedPoint)](Sandbox.ModAPI.Ingame.IMyProductionBlock.InsertQueueItem)|Inserts a blueprint into the production queue|
|\\%1void InsertQueueItem(int, MyDefinitionId, decimal)](Sandbox.ModAPI.Ingame.IMyProductionBlock.InsertQueueItem)|Inserts a blueprint into the production queue|
|\\%1void InsertQueueItem(int, MyDefinitionId, double)](Sandbox.ModAPI.Ingame.IMyProductionBlock.InsertQueueItem)|Inserts a blueprint into the production queue|
...
|\\%1void MoveQueueItemRequest(uint, int)](Sandbox.ModAPI.Ingame.IMyProductionBlock.MoveQueueItemRequest)|Moves an item in the queue to a target position in the queue.|
|\\%1void RemoveQueueItem(int, MyFixedPoint)](Sandbox.ModAPI.Ingame.IMyProductionBlock.RemoveQueueItem)|Removes an item from the queue|
|\\%1void RemoveQueueItem(int, decimal)](Sandbox.ModAPI.Ingame.IMyProductionBlock.RemoveQueueItem)|Removes an item from the queue|
|\\%1void RemoveQueueItem(int, double)](Sandbox.ModAPI.Ingame.IMyProductionBlock.RemoveQueueItem)|Removes an item from the queue|
