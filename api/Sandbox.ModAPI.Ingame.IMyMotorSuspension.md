...
|Member|Description|
|---|---|
|\\$1bool AirShockEnabled { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.AirShockEnabled)|Enables or disables AirShock function.|
...
|\\$1bool Brake { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Brake)|Gets or sets if brakes are applied to the wheel. This is not a brake override.|
