...
|Member|Description|
|---|---|
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyCollector.UseConveyorSystem)|Gets or sets whether this collector block should push out items from it|
