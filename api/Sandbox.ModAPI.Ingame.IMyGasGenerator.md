...
|Member|Description|
|---|---|
|[AutoRefill { get; set; }](Sandbox.ModAPI.Ingame.IMyGasGenerator.AutoRefill)|Autorefill enabled|
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyGasGenerator.UseConveyorSystem)|Conveyor system enabled|
