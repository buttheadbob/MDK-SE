...
<tr><td>[`void RemovePoint(ref Vector3D point)`](VRageMath.Spatial.RemovePoint)</td><td></td></tr>
<tr><td>[`Enumerator<T> GetPointsCloserThan(ref Vector3D point, double dist)`](VRageMath.Spatial.GetPointsCloserThan)</td><td></td></tr>
<tr><td>[`void RemoveTwo(ref Enumerator<T> en0, ref Enumerator<T> en1)`](VRageMath.Spatial.RemoveTwo)</td><td></td></tr>
