...
|Member|Description|
|---|---|
|[`float Position`](VRageMath.Position)||
|[`float Value`](VRageMath.Value)||
|[`float TangentIn`](VRageMath.TangentIn)||
|[`float TangentOut`](VRageMath.TangentOut)||
|[`CurveContinuity Continuity`](VRageMath.Continuity)||
### Methods
|Member|Description|
|---|---|
|[`CurveKey Clone()`](VRageMath.Clone)||
