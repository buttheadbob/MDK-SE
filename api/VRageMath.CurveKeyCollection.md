...
|---|---|
|[`Item`](VRageMath.Item)||
|[`Count`](VRageMath.Count)|Gets the number of elements contained in the CurveKeyCollection.|
|[`IsReadOnly`](VRageMath.IsReadOnly)|Returns a value indicating whether the CurveKeyCollection is read-only.|
### Methods
|Member|Description|
|---|---|
|[`Add(Object)`](VRageMath.Add)||
|[`IndexOf(CurveKey)`](VRageMath.IndexOf)|Determines the index of a CurveKey in the CurveKeyCollection.|
|[`RemoveAt(int)`](VRageMath.RemoveAt)|Removes the CurveKey at the specified index.|
