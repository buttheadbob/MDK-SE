...
|Member|Description|
|---|---|
|\\$1bool AutoLock { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.AutoLock)|Toggles the autolock of the landing gear.|
...
|\\$1bool IsBreakable { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.IsBreakable)|_**Obsolete:** Landing gear are not breakable anymore._<br /><br />Gets if the landing gear lock can be broken with force.|
...
|\\$1bool IsLocked { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.IsLocked)|Gets whether the landing gear is currently locked.|
|\\$1bool IsParkingEnabled { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.IsParkingEnabled)||
...
|\\$1LandingGearMode LockMode { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.LockMode)|Is this block triggered by the parking signal?|
...
|\\$1void Lock()](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.Lock)|Locks the landing gear.|
...
|\\$1void ResetAutoLock()](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.ResetAutoLock)|Resets autolock timer|
...
|\\$1void ToggleLock()](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.ToggleLock)|Toggles the landing gear lock.|
|\\$1void Unlock()](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.Unlock)|Unlocks the landing gear.|
