...
|[void GetAcceptedItems(List\<MyItemType>, Func\<MyItemType, bool> = null)](VRage.Game.ModAPI.Ingame.IMyInventory.GetAcceptedItems)|Returns all items this inventory accepts.|
...
|[void GetItems(List\<MyInventoryItem>, Func\<MyInventoryItem, bool> = null)](VRage.Game.ModAPI.Ingame.IMyInventory.GetItems)|Collects all items present inside this inventory and returns snapshot of the current inventory state.|
