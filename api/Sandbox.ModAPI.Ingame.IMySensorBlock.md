...
```csharp
private public abstract IMySensorBlock
```
...
|Member|Description|
|---|---|
|[MaxRange](Sandbox.ModAPI.Ingame.IMySensorBlock.MaxRange)|Gets the maximum range of the sensor in any direction.|
|[LeftExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.LeftExtend)|Gets or sets the left range of the sensor.|
|[RightExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.RightExtend)|Gets or sets the right range of the sensor.|
|[TopExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.TopExtend)|Gets or sets the top range of the sensor.|
|[BottomExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.BottomExtend)|Gets or sets the bottom range of the sensor.|
|[FrontExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.FrontExtend)|Gets or sets the front range of the sensor.|
|[BackExtend](Sandbox.ModAPI.Ingame.IMySensorBlock.BackExtend)|Gets or sets the back range of the sensor.|
|[PlayProximitySound](Sandbox.ModAPI.Ingame.IMySensorBlock.PlayProximitySound)|Gets or sets if the proximity sound plays when an entity is detected.|
|[DetectPlayers](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectPlayers)|Gets or sets if the sensor should detect players.|
|[DetectFloatingObjects](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectFloatingObjects)|Gets or sets if the sensor should detect floating objects (components, rocks).|
|[DetectSmallShips](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectSmallShips)|Gets or sets if the sensor should detect small ships.|
|[DetectLargeShips](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectLargeShips)|Gets or sets if the sensor should detect large ships.|
|[DetectStations](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectStations)|Gets or sets if the sensor should detect large stations.|
|[DetectSubgrids](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectSubgrids)|Gets or sets if the sensor should detect subgrids (eg. connected by connector).|
|[DetectAsteroids](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectAsteroids)|Gets or sets if the sensor should detect asteroids or planets.|
|[DetectOwner](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectOwner)|Gets or sets if the sensor should detect the block owner.|
|[DetectFriendly](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectFriendly)|Gets or sets if the sensor should detect friendly players.|
|[DetectNeutral](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectNeutral)|Gets or sets if the sensor should detect neutral players.|
|[DetectEnemy](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectEnemy)|Gets or sets if the sensor should detect enemy players.|
|[IsActive](Sandbox.ModAPI.Ingame.IMySensorBlock.IsActive)|Gets if there is any entity currently being detected.|
|[LastDetectedEntity](Sandbox.ModAPI.Ingame.IMySensorBlock.LastDetectedEntity)||
...
|Member|Description|
|---|---|
|[DetectedEntities(List)](Sandbox.ModAPI.Ingame.IMySensorBlock.DetectedEntities)||
