...
```csharp[double](System.Double) Dot([Vector2D](VRageMath.Vector2D) value1, [Vector2D](VRageMath.Vector2D) value2)```##### Summary
...
```csharpvoid Dot(ref [Vector2D](VRageMath.Vector2D) value1, ref [Vector2D](VRageMath.Vector2D) value2, ref [double](System.Double) result)```##### Summary
