...
|Member|Description|
|---|---|
|[IsCountingDown { get; }](Sandbox.ModAPI.Ingame.IMyWarhead.IsCountingDown)|Gets whether this warhead block is counting down|
|[DetonationTime { get; set; }](Sandbox.ModAPI.Ingame.IMyWarhead.DetonationTime)|Gets actual detonation time [s]|
|[IsArmed { get; set; }](Sandbox.ModAPI.Ingame.IMyWarhead.IsArmed)|Gets or sets whether this warhead block is armed|
...
|Member|Description|
|---|---|
|[StartCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StartCountdown)|Start the countdown|
|[StopCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StopCountdown)|Stops the countdown|
|[Detonate()](Sandbox.ModAPI.Ingame.IMyWarhead.Detonate)|Detonates the warhead|
