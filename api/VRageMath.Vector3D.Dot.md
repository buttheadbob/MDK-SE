...
```csharp
public static void Dot(ref Vector3D vector1, ref Vector3D vector2, ref double result)
```
...
```csharp
public static void Dot(ref Vector3D vector1, ref Vector3 vector2, ref double result)
```
...
```csharp
public static void Dot(ref Vector3 vector1, ref Vector3D vector2, ref double result)
```
