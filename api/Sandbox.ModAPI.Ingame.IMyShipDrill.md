...
|Member|Description|
|---|---|
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyShipDrill.UseConveyorSystem)||
|[IsActivated { get; }](Sandbox.ModAPI.Ingame.IMyShipDrill.IsActivated)|True if the drill is activated by mouse click or toggling via terminal.|
