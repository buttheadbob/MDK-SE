...
|Member|Description|
|---|---|
|[AutoRefill { get; set; }](Sandbox.ModAPI.Ingame.IMyGasGenerator.AutoRefill)|Gets or sets bottles auto refill enabled|
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyGasGenerator.UseConveyorSystem)|Gets or sets whether block can use conveyor system (pull ice and hydrogen/oxygen bottles)|
