...
|Member|Description|
|---|---|
|\\%1bool CancelStoreItem(long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.CancelStoreItem)|Cancels the item (either order or offer).|
...
|\\%1void GetPlayerStoreItems(List\\%1MyStoreQueryItem>)](Sandbox.ModAPI.Ingame.IMyStoreBlock.GetPlayerStoreItems)|Returns player store items.|
...
|\\%1MyStoreInsertResults InsertOffer(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.InsertOffer)|Creates store item offer and returns its id.|
|\\%1MyStoreInsertResults InsertOrder(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.InsertOrder)|Creates store item order and returns its id.|
