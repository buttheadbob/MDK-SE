...
|Member|Description|
|---|---|
|static [`double E`](VRageMath.E)|Represents the mathematical constant e.|
|static [`double Pi`](VRageMath.Pi)|Represents the value of pi.|
|static [`double TwoPi`](VRageMath.TwoPi)|Represents the value of pi times two.|
|static [`double FourPi`](VRageMath.FourPi)|Represents the value of pi times four.|
|static [`double PiOver2`](VRageMath.PiOver2)|Represents the value of pi divided by two.|
|static [`double PiOver4`](VRageMath.PiOver4)|Represents the value of pi divided by four.|
### Methods
|Member|Description|
|---|---|
