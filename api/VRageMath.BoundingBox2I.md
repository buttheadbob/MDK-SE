...
```csharp
public struct BoundingBox2I: IEquatable
```
...
|[static BoundingBox2I CreateFromPoints(IEnumerable)](VRageMath.BoundingBox2I.CreateFromPoints)|Creates the smallest BoundingBox2I that will contain a group of points.|
