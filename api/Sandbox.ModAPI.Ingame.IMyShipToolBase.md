...
|[bool IsActivated { get; }](Sandbox.ModAPI.Ingame.IMyShipToolBase.IsActivated)|True if the tool is activated by mouse click or toggling via terminal.|
...
|[bool UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyShipToolBase.UseConveyorSystem)|Gets or sets if block should push/pull items from conveyor system|
