...
```csharp
private public interface.IMyMechanicalConnectionBlock
```
...
|Member|Description|
|---|---|
|[TopGrid](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.TopGrid)|Gets the grid of the attached top part|
|[Top](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.Top)|Gets the attached top part entity|
...
|[SafetyLock](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.SafetyLock)|_**Obsolete:** SafetyLock is no longer supported. This is property dummy property only, for backwards compatibility._<br /><br />Gets if the block is safety locked (welded)|
|[IsAttached](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.IsAttached)|Gets if the block base is attached to something|
|[IsLocked](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.IsLocked)|_**Obsolete:** SafetyLock is no longer supported. This is property dummy property only, for backwards compatibility._<br /><br />Gets if the block is safety locked (welded)|
|[PendingAttachment](Sandbox.ModAPI.Ingame.IMyMechanicalConnectionBlock.PendingAttachment)|Gets if the block is looking for a top part|
