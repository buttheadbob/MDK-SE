...
```csharp
private public abstract IMyLandingGear
```
...
|Member|Description|
|---|---|
|[IsBreakable](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.IsBreakable)|_**Obsolete:** Landing gear are not breakable anymore._<br /><br />Gets if the landing gear lock can be broken with force.|
|[IsLocked](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.IsLocked)|Gets whether the landing gear is currently locked.|
|[AutoLock](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.AutoLock)|Toggles the autolock of the landing gear.|
|[LockMode](SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear.LockMode)|Gets the current lock state of the landing gear.|
