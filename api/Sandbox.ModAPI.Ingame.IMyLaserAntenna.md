...
<tr><td>_<a href="Sandbox.ModAPI.Ingame.RequireLoS"><code>bool RequireLoS</code></a>_</td><td>Determines whether this particular antenna requires line of sight to function.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.TargetCoords"><code>Vector3D TargetCoords</code></a>_</td><td>get target coordinates</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.IsPermanent"><code>bool IsPermanent</code></a>_</td><td>Connection is permanent</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.IsOutsideLimits"><code>bool IsOutsideLimits</code></a>_</td><td>Target is outside movement limits of antenna</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Status"><code>MyLaserAntennaStatus Status</code></a>_</td><td>Gets the current status of this antenna.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.AttachedProgrammableBlock"><code>long AttachedProgrammableBlock</code></a>_</td><td>Gets or sets the EntityID of the Programmable Block attached to this antenna.</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Range"><code>float Range</code></a>_</td><td>Gets or sets the max range of the laser set in terminal</td></tr>
...
### Methods
<table style="width:100%;display:table">
<tr><td>_<a href="Sandbox.ModAPI.Ingame.SetTargetCoords"><code>void SetTargetCoords(string coords)</code></a>_</td><td>Set coordinates of target</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.Connect"><code>void Connect()</code></a>_</td><td>Connect to target defined by SetTargetCoords</td></tr>
<tr><td>_<a href="Sandbox.ModAPI.Ingame.TransmitMessage"><code>bool TransmitMessage(string message)</code></a>_</td><td>Sends a message to the programmable block associated with this antenna's partner. Limited to 100,000 characters.</td></tr>
