...
|Member|Description|
|---|---|
|[UseConveyorSystem { get; set; }](Sandbox.ModAPI.Ingame.IMyReactor.UseConveyorSystem)|Gets or sets whether this reactor block should pull items from conveyor system|
