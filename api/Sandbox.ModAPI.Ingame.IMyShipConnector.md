...
```csharp
private public abstract IMyShipConnector
```csharp
...
|Member|Description|
|---|---|
|[ThrowOut](Sandbox.ModAPI.Ingame.IMyShipConnector.ThrowOut)|Gets or sets whether this connector should throw out anything placed in its inventory.|
|[CollectAll](Sandbox.ModAPI.Ingame.IMyShipConnector.CollectAll)|Gets or sets whether this connector should be pulling items into its inventory.|
|[PullStrength](Sandbox.ModAPI.Ingame.IMyShipConnector.PullStrength)|Gets or sets the currently configured strength of the pull when the connector is within range of another.|
|[IsLocked](Sandbox.ModAPI.Ingame.IMyShipConnector.IsLocked)|_**Obsolete:** Use the Status property_|
|[IsConnected](Sandbox.ModAPI.Ingame.IMyShipConnector.IsConnected)|_**Obsolete:** Use the Status property_|
|[Status](Sandbox.ModAPI.Ingame.IMyShipConnector.Status)|Determines the current status of the connector.|
|[OtherConnector](Sandbox.ModAPI.Ingame.IMyShipConnector.OtherConnector)|Gets the connector this one is connected to when [Status](Sandbox.ModAPI.Ingame.IMyShipConnector.Status) is ConnectorStatus.Connected .|
