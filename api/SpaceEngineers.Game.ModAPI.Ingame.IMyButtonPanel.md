...
```csharp
private public interface.IMyButtonPanel
```
...
|Member|Description|
|---|---|
|[AnyoneCanUse](SpaceEngineers.Game.ModAPI.Ingame.IMyButtonPanel.AnyoneCanUse)|Gets or sets if anyone is allowed to activate the buttons.|
