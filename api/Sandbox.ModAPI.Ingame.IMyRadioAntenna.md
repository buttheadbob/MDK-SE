...
|[bool EnableBroadcasting { get; set; }](Sandbox.ModAPI.Ingame.IMyRadioAntenna.EnableBroadcasting)|Gets or sets if broadcasting is enabled|
...
|[string HudText { get; set; }](Sandbox.ModAPI.Ingame.IMyRadioAntenna.HudText)|Gets or sets text displayed in the spawn menu|
...
|[bool IsBroadcasting { get; }](Sandbox.ModAPI.Ingame.IMyRadioAntenna.IsBroadcasting)|Returns true if antenna is broadcasting|
...
|[float Radius { get; set; }](Sandbox.ModAPI.Ingame.IMyRadioAntenna.Radius)|Gets or sets Broadcasting/Receiving range|
...
|[bool ShowShipName { get; set; }](Sandbox.ModAPI.Ingame.IMyRadioAntenna.ShowShipName)|Gets or sets show shipname on hud|
