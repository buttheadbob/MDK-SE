...
|Member|Description|
|---|---|
|[`Items`](VRage.Game.ModAPI.Ingame.Utilities.Items)|Contains all items, both arguments and switches|
|[`Switches`](VRage.Game.ModAPI.Ingame.Utilities.Switches)|Contains a list of all detected switches|
|[`ArgumentCount`](VRage.Game.ModAPI.Ingame.Utilities.ArgumentCount)|Returns the number of non-switch arguments|
### Methods
|Member|Description|
|---|---|
