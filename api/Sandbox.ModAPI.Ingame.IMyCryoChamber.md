...
|[OxygenCapacity { get; }](Sandbox.ModAPI.Ingame.IMyCockpit.OxygenCapacity)|Gets the maximum oxygen capacity of this cockpit.<br /><br />_Inherited from [IMyCockpit](Sandbox.ModAPI.Ingame.IMyCockpit)_|
|[OxygenFilledRatio { get; }](Sandbox.ModAPI.Ingame.IMyCockpit.OxygenFilledRatio)|Gets the current oxygen level of this cockpit, as a value between 0 (empty) and 1 (full).<br /><br />_Inherited from [IMyCockpit](Sandbox.ModAPI.Ingame.IMyCockpit)_|
