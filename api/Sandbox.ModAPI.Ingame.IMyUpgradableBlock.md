...
|\\$1uint UpgradeCount { get; }](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.UpgradeCount)|Gets number of upgrades applied|
...
|\\$1void GetUpgrades(out Dictionary\\$1string, float>)](Sandbox.ModAPI.Ingame.IMyUpgradableBlock.GetUpgrades)|Get list of upgrades. Read only.|
