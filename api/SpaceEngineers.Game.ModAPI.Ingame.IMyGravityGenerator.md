...
```csharp
private public interface.IMyGravityGenerator
```
...
|Member|Description|
|---|---|
|[FieldWidth](SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGenerator.FieldWidth)|_**Obsolete:** Use FieldSize.X_|
|[FieldHeight](SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGenerator.FieldHeight)|_**Obsolete:** Use FieldSize.Y_|
|[FieldDepth](SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGenerator.FieldDepth)|_**Obsolete:** Use FieldSize.Z_|
|[FieldSize](SpaceEngineers.Game.ModAPI.Ingame.IMyGravityGenerator.FieldSize)|Gets or sets the gravity field as a Vector3(W,H,D).|
