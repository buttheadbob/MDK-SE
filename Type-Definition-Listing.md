...
**Advanced Rotor** ([IMyMotorAdvancedStator](api/{type}.md))  
...
**Corner LCD Flat Top** ([IMyTextPanel](api/{type}.md))  
...
**Corner Light - Double** ([IMyInteriorLight](api/{type}.md))  
...
**Industrial Cockpit** ([IMyCockpit](api/{type}.md))  
...
**Large Cargo Container** ([IMyCargoContainer](api/{type}.md))  
...
**Large Hydrogen Thruster** ([IMyThrust](api/{type}.md))  
...
**Power Efficiency Module** ([IMyUpgradeModule](api/{type}.md))  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Large Grid: `MyObjectBuilder_UpgradeModule/LargeEnergyModule`

**Programmable block** ([IMyProgrammableBlock](api/{type}.md))  
...
**Refinery** ([IMyRefinery](api/{type}.md))  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Large Grid: `MyObjectBuilder_Refinery/LargeRefinery`

**Reloadable Rocket Launcher** ([IMySmallMissileLauncherReload](api/{type}.md))  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Small Grid: `MyObjectBuilder_SmallMissileLauncherReload/SmallRocketLauncherReload`

**Remote Control** ([IMyRemoteControl](api/{type}.md))  
