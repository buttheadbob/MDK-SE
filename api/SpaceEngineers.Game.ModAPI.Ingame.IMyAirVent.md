...
|Member|Description|
|---|---|
|[CanPressurize { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.CanPressurize)|Can fill room with air true - room is airtight false - room is not airtight|
|[IsDepressurizing { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.IsDepressurizing)|_**Obsolete:** IsDepressurizing is deprecated, please use Depressurize instead._<br /><br />Vent mode false - pressurize (filling room) true - depressurize (sucking air out)|
|[Depressurize { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Depressurize)|Vent mode false - pressurize (filling room) true - depressurize (sucking air out)|
|[Status { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.Status)|Gets current air vent status|
|[PressurizationEnabled { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent.PressurizationEnabled)|Returns true if pressurization is enabled.|
