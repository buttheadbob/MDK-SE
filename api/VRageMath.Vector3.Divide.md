...
```csharp
public static void Divide(ref Vector3 value1, ref Vector3 value2, ref Vector3 result)
```
...
```csharp
public static void Divide(ref Vector3 value1, float value2, ref Vector3 result)
```
