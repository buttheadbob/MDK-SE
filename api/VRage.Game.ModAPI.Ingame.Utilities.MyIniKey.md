...
|[`MyIniKey Parse(string input)`](VRage.Game.ModAPI.Ingame.Utilities.Parse)|Parses a string in the form of`<br/>section/key`<br/>into aT:VRage.Game.ModAPI.Ingame.Utilities.MyIniKeyobject.|
