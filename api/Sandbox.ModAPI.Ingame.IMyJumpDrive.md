...
```csharp
private public interface.IMyJumpDrive
```
...
|Member|Description|
|---|---|
|[CurrentStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive.CurrentStoredPower)||
|[MaxStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive.MaxStoredPower)||
|[Status](Sandbox.ModAPI.Ingame.IMyJumpDrive.Status)||
