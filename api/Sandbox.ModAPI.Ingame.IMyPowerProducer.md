...
|[float CurrentOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.CurrentOutput)|Gets current output in Megawatts|
...
|[float MaxOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.MaxOutput)|Gets maximum output in Megawatts|
