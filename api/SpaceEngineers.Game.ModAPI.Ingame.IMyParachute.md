...
[float Atmosphere { get; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.Atmosphere)

> Atmospheric Density at the block. Returns 0.0f if not near a planet.

[bool AutoDeploy { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.AutoDeploy)

> Gets or sets if the parachute should automatically deploy.

[float AutoDeployHeight { get; set; }](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.AutoDeployHeight)
...
[void CloseDoor()](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute.CloseDoor)
