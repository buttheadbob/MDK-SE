...
|[Velocity { get; set; }](Sandbox.ModAPI.Ingame.IMyPistonBase.Velocity)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[MaxVelocity { get; }](Sandbox.ModAPI.Ingame.IMyPistonBase.MaxVelocity)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[MinLimit { get; set; }](Sandbox.ModAPI.Ingame.IMyPistonBase.MinLimit)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[MaxLimit { get; set; }](Sandbox.ModAPI.Ingame.IMyPistonBase.MaxLimit)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[LowestPosition { get; }](Sandbox.ModAPI.Ingame.IMyPistonBase.LowestPosition)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[HighestPosition { get; }](Sandbox.ModAPI.Ingame.IMyPistonBase.HighestPosition)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[CurrentPosition { get; }](Sandbox.ModAPI.Ingame.IMyPistonBase.CurrentPosition)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[Status { get; }](Sandbox.ModAPI.Ingame.IMyPistonBase.Status)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
...
|[Extend()](Sandbox.ModAPI.Ingame.IMyPistonBase.Extend)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[Retract()](Sandbox.ModAPI.Ingame.IMyPistonBase.Retract)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
|[Reverse()](Sandbox.ModAPI.Ingame.IMyPistonBase.Reverse)|_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
