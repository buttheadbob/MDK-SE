...
```csharp
public struct BoundingBoxD: IEquatable
```
...
|Member|Description|
|---|---|
|[static BoundingBoxD CreateFromPoints(IEnumerable)](VRageMath.BoundingBoxD.CreateFromPoints)|Creates the smallest BoundingBox that will contain a group of points.|
