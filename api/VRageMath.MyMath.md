...
[static Vector3 AngleTo(Vector3, Vector3)](VRageMath.MyMath.AngleTo)

> AngleTo

[static float ArcTanAngle(float, float)](VRageMath.MyMath.ArcTanAngle)
...
[static float DistanceSquaredFromLineSegment(Vector3, Vector3, Vector3)](VRageMath.MyMath.DistanceSquaredFromLineSegment)
...
[static float FastTanH(float)](VRageMath.MyMath.FastTanH)

> Fast approximation of Hyperbolic tangent Max deviation is <3%

[static Vector3 ForwardVectorProjection(Vector3, Vector3)](VRageMath.MyMath.ForwardVectorProjection)
...
[static Vector3 MaxComponents(ref Vector3, ref Vector3)](VRageMath.MyMath.MaxComponents)
...
[static Vector3 QuaternionToEuler(Quaternion)](VRageMath.MyMath.QuaternionToEuler)

> QuaternionToEuler

[static Vector3 VectorFromColor(byte, byte, byte)](VRageMath.MyMath.VectorFromColor)
