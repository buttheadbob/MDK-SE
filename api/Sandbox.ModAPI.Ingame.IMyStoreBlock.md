...
|Member|Description|
|---|---|
|[bool CancelStoreItem(long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.CancelStoreItem)|Cancels the item (either order or offer).|
...
|[void GetPlayerStoreItems(List\<MyStoreQueryItem>)](Sandbox.ModAPI.Ingame.IMyStoreBlock.GetPlayerStoreItems)|Returns player store items.|
...
|[MyStoreInsertResults InsertOffer(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.InsertOffer)|Creates store item offer and returns its id.|
|[MyStoreInsertResults InsertOrder(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock.InsertOrder)|Creates store item order and returns its id.|
