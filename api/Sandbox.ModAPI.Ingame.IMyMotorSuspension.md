...
|Member|Description|
|---|---|
|[Steering { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Steering)|Gets or sets whether suspension can steer|
|[Propulsion { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Propulsion)|Gets or sets whether suspension can propulse|
|[InvertSteer { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.InvertSteer)|Gets or sets whether suspension steering is inverted|
|[InvertPropulsion { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.InvertPropulsion)|Gets or sets whether suspension propulsion is inverted|
|[IsParkingEnabled { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.IsParkingEnabled)|Gets or sets whether suspension reacts on parking break|
|[Damping { get; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Damping)|_**Obsolete**_|
|[Strength { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Strength)|Gets or sets whether suspension strength [0..100]%|
|[Friction { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Friction)|Gets or sets whether suspension friction [0..100]%|
|[Power { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Power)|Gets or sets whether suspension power [0..100]%|
|[Height { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.Height)|Gets or sets whether suspension height in meters. Limited with block definition settings|
|[SteerAngle { get; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.SteerAngle)|Gets suspension current steering angle|
|[MaxSteerAngle { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorSuspension.MaxSteerAngle)|Gets or sets max steering angle in radians.|
