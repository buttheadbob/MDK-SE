...
```csharp
private public interface.IMyTimerBlock
```
...
|Member|Description|
|---|---|
|[IsCountingDown](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.IsCountingDown)|Gets if the timer block is active and counting down|
|[TriggerDelay](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.TriggerDelay)|Gets or sets the countdown time, in seconds|
|[Silent](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.Silent)|Gets or sets if the countdown is silent|
...
|Member|Description|
|---|---|
|[Trigger()](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.Trigger)|Trigger immediately, skips countdown|
|[StartCountdown()](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.StartCountdown)|Begin countdown|
|[StopCountdown()](SpaceEngineers.Game.ModAPI.Ingame.IMyTimerBlock.StopCountdown)|Stops current countdown|
