...
```csharp
private public private public interface.IEnumerable<T> EnumerateRange(private public sealed struct.Vector3L minInclusive, private public sealed struct.Vector3L maxExclusive)
```
