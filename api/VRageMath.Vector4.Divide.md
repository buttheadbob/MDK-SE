...
```csharp
public static void Divide(ref Vector4 value1, ref Vector4 value2, ref Vector4 result)
```
...
```csharp
public static void Divide(ref Vector4 value1, float divider, ref Vector4 result)
```
