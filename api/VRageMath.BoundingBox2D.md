...
|[static BoundingBox2D CreateFromPoints(IEnumerable)](VRageMath.BoundingBox2D.CreateFromPoints)|Creates the smallest BoundingBox2D that will contain a group of points.|
