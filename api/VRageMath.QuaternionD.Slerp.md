...
```csharp
public QuaternionD Slerp(QuaternionD quaternion1, QuaternionD quaternion2, double amount)
```
...
```csharp
public void Slerp(ref QuaternionD quaternion1, ref QuaternionD quaternion2, double amount, ref QuaternionD result)
```
