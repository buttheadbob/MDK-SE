...
|Member|Description|
|---|---|
|\\$1float Angle { get; }](Sandbox.ModAPI.Ingame.IMyMotorStator.Angle)|Gets the current angle of the rotor in radians.|
...
|\\$1float BrakingTorque { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.BrakingTorque)|Gets or sets the torque applied when stopping the rotor top|
...
|\\$1float Displacement { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.Displacement)|Gets or sets the vertical displacement of the rotor top|
...
|\\$1float LowerLimitDeg { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.LowerLimitDeg)|Gets or sets the lower angle limit of the rotor in degrees. Set to float.MinValue for no limit.|
|\\$1float LowerLimitRad { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.LowerLimitRad)|Gets or sets the lower angle limit of the rotor in radians. Set to float.MinValue for no limit.|
...
|\\$1bool RotorLock { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.RotorLock)|Gets or sets rotor lock|
...
|\\$1float TargetVelocityRad { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.TargetVelocityRad)|Gets or sets the desired velocity of the rotor in radians/second|
|\\$1float TargetVelocityRPM { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.TargetVelocityRPM)|Gets or sets the desired velocity of the rotor in RPM|
...
|\\$1float Torque { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.Torque)|Gets or sets the torque applied when moving the rotor top|
|\\$1float UpperLimitDeg { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.UpperLimitDeg)|Gets or sets the upper angle limit of the rotor in degrees. Set to float.MaxValue for no limit.|
|\\$1float UpperLimitRad { get; set; }](Sandbox.ModAPI.Ingame.IMyMotorStator.UpperLimitRad)|Gets or sets the upper angle limit of the rotor in radians. Set to float.MaxValue for no limit.|
