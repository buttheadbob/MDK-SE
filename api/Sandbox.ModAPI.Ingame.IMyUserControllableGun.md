...
|Member|Description|
|---|---|
|[IsShooting { get; }](Sandbox.ModAPI.Ingame.IMyUserControllableGun.IsShooting)||
|[Shoot { get; set; }](Sandbox.ModAPI.Ingame.IMyUserControllableGun.Shoot)|Toggle shooting on or off.|
