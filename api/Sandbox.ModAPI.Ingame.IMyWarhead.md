...
|\\$1float DetonationTime { get; set; }](Sandbox.ModAPI.Ingame.IMyWarhead.DetonationTime)|Gets actual detonation time [s]|
...
|\\$1bool IsArmed { get; set; }](Sandbox.ModAPI.Ingame.IMyWarhead.IsArmed)|Gets or sets whether this warhead block is armed|
...
|\\$1bool IsCountingDown { get; }](Sandbox.ModAPI.Ingame.IMyWarhead.IsCountingDown)|Gets whether this warhead block is counting down|
...
|Member|Description|
|---|---|
|\\$1void Detonate()](Sandbox.ModAPI.Ingame.IMyWarhead.Detonate)|Detonates the warhead|
...
|\\$1bool StartCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StartCountdown)|Start the countdown|
|\\$1bool StopCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StopCountdown)|Stops the countdown|
