...
```csharp[float](System.Single) Dot([Vector2](VRageMath.Vector2) value1, [Vector2](VRageMath.Vector2) value2)```##### Summary
...
```csharpvoid Dot(ref [Vector2](VRageMath.Vector2) value1, ref [Vector2](VRageMath.Vector2) value2, ref [float](System.Single) result)```##### Summary
