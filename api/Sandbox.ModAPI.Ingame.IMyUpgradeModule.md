...
|[void GetUpgradeList(out List<VRage.Game.ObjectBuilders.Definitions.MyUpgradeModuleInfo>)](Sandbox.ModAPI.Ingame.IMyUpgradeModule.GetUpgradeList)|Gets list of upgrades from this block, see [VRage.Game.ObjectBuilders.Definitions.MyUpgradeModuleInfo](https://docs.microsoft.com/en-us/dotnet/api/vrage.game.objectbuilders.definitions.myupgrademoduleinfo?view=netframework-4.6) for details|
