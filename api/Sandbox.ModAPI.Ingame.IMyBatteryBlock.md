...
|Member|Description|
|---|---|
|[HasCapacityRemaining { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.HasCapacityRemaining)||
|[CurrentStoredPower { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.CurrentStoredPower)||
|[MaxStoredPower { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.MaxStoredPower)||
|[CurrentInput { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.CurrentInput)||
|[MaxInput { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.MaxInput)||
|[IsCharging { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.IsCharging)||
|[ChargeMode { get; set; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.ChargeMode)||
...
|[CurrentOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.CurrentOutput)|Current output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|[MaxOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.MaxOutput)|Maximum output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
