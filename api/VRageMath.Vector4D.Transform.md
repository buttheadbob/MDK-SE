...
```csharp
public static void Transform(ref Vector2 position, ref MatrixD matrix, ref Vector4D result)
```
...
```csharp
public static void Transform(ref Vector3D position, ref MatrixD matrix, ref Vector4D result)
```
...
```csharp
public static void Transform(ref Vector4D vector, ref MatrixD matrix, ref Vector4D result)
```
...
```csharp
public static void Transform(ref Vector2 value, ref Quaternion rotation, ref Vector4D result)
```
...
```csharp
public static void Transform(ref Vector3D value, ref Quaternion rotation, ref Vector4D result)
```
...
```csharp
public static void Transform(ref Vector4D value, ref Quaternion rotation, ref Vector4D result)
```
