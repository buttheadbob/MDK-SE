...
```csharp[float](System.Single) Dot([Vector3](VRageMath.Vector3) vector1, [Vector3](VRageMath.Vector3) vector2)```##### Summary
...
```csharpvoid Dot(ref [Vector3](VRageMath.Vector3) vector1, ref [Vector3](VRageMath.Vector3) vector2, ref [float](System.Single) result)```##### Summary
...
```csharp[float](System.Single) Dot([Vector3](VRageMath.Vector3) v)``````csharp[float](System.Single) Dot(ref [Vector3](VRageMath.Vector3) v)```