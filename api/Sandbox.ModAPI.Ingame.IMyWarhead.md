...
```csharp
private public abstract IMyWarhead
```csharp
...
|Member|Description|
|---|---|
|[IsCountingDown](Sandbox.ModAPI.Ingame.IMyWarhead.IsCountingDown)||
|[DetonationTime](Sandbox.ModAPI.Ingame.IMyWarhead.DetonationTime)||
|[IsArmed](Sandbox.ModAPI.Ingame.IMyWarhead.IsArmed)||
...
|Member|Description|
|---|---|
|[StartCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StartCountdown)||
|[StopCountdown()](Sandbox.ModAPI.Ingame.IMyWarhead.StopCountdown)||
|[Detonate()](Sandbox.ModAPI.Ingame.IMyWarhead.Detonate)||
