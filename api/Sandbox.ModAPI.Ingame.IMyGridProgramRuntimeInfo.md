...
|Member|Description|
|---|---|
|[`System.TimeSpan TimeSinceLastRun`](Sandbox.ModAPI.Ingame.TimeSinceLastRun)|Gets the time elapsed since the last time the Main method of this program was run. This property returns no valid data neither in the constructor nor the Save method.|
...
|[`Sandbox.ModAPI.Ingame.UpdateFrequency UpdateFrequency`](Sandbox.ModAPI.Ingame.UpdateFrequency)|Gets or sets how frequently this script will run itself|
