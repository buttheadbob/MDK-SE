...
|\\$1ChargeMode ChargeMode { get; set; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.ChargeMode)|Gets or sets charge mode|
...
|\\$1float CurrentInput { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.CurrentInput)|Gets current power input|
|\\$1float CurrentOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.CurrentOutput)|Gets current output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|\\$1float CurrentStoredPower { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.CurrentStoredPower)|Gets current stored power|
...
|\\$1bool HasCapacityRemaining { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.HasCapacityRemaining)|Gets whether this battery block has any remaining capacity|
...
|\\$1bool IsCharging { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.IsCharging)|Gets whether this battery block is charging|
...
|\\$1float MaxInput { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.MaxInput)|Gets current maximum power input|
|\\$1float MaxOutput { get; }](Sandbox.ModAPI.Ingame.IMyPowerProducer.MaxOutput)|Gets maximum output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|\\$1float MaxStoredPower { get; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.MaxStoredPower)|Gets maximum stored power|
...
|\\$1bool OnlyDischarge { get; set; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.OnlyDischarge)|_**Obsolete:** Use ChargeMode instead_|
|\\$1bool OnlyRecharge { get; set; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.OnlyRecharge)|_**Obsolete:** Use ChargeMode instead_|
...
|\\$1bool SemiautoEnabled { get; set; }](Sandbox.ModAPI.Ingame.IMyBatteryBlock.SemiautoEnabled)|_**Obsolete:** Semi-auto is no longer a valid mode, if you want to check for Auto instead, use ChargeMode_|
