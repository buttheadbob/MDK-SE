...
```csharp
public MySprite(SpriteType type, string data, Nullable<VRageMath.Vector2> position, Nullable<VRageMath.Vector2> size, Nullable<VRageMath.Color> color, string fontId, TextAlignment alignment, float rotation)
```
